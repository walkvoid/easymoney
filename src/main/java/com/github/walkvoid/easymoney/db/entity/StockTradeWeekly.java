...
/**
 * @ApiModel(description = "股票每周统计信息实体类")
 */
@ApiModel(description = "股票每周统计信息实体类")
@Data
public class StockTradeWeekly implements Serializable {
    ...
    @ApiModelProperty(value = "周开始日期", required = true, example = "2023-01-02")
    private LocalDate weekStart;

    @ApiModelProperty(value = "周结束日期", required = true, example = "2023-01-08")
    private LocalDate weekEnd;

    @ApiModelProperty(value = "某年的第几周", required = true, example = "202332")
