...
/**
 * @ApiModel(description = "股票每季度统计信息实体类")
 */
@ApiModel(description = "股票每季度统计信息实体类")
@Data
public class StockTradeQuarterly  implements Serializable {
    ...
    @ApiModelProperty(value = "季度（格式：YYYY-Q1）", required = true, example = "2023-Q1")
